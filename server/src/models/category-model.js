...
categorySchema.statics.validateData = (categoryData) => categoryValidationSchema
  .validate(categoryData);
categorySchema.statics.validateUpdateData = (categoryData) => categoryUpdateValidationSchema
  .validate(categoryData);
